...
export default function Home() {
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="flex min-h-full flex-1 flex-col justify-center align-items-center mb-10">
          <Image
              ...
              priority
            />
          <h1 className="mt-2 text-4xl text-center font-bold leading-9 tracking-tight text-gray-900">
            Task Management App
          </h1>
      </div>
